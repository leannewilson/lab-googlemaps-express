...
router.post("/", (req, res, next) => {
  ...
  //** For now, users will have to enter the longitude and latitude by entering floating numbers. If you want to enable the users to find a place entering its name you have to use the Google Maps Geocoder object. Keep this in mind so you can research more about this later on your own. **/
